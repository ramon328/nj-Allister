...
import { useFinePointer, useReducedMotion } from "../use-motion";
import { gsap, lockScroll, reduced } from "../motion";
...
/* ------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------ */
export function TopBar({ announcements: announce }: { announcements?: string[] }) {
  ...
  const base = announce && announce.length ? announce : announcements;
        ...
        <div className="nav">
          <div className="nav__pill">
            ...
            <div className="nav__actions">
              ...
              <a href={links.account} className="nav__icon" aria-label="Seguir mi pedido">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"><path d="M4 7h16v13H4zM4 7l2-3h12l2 3M9 11h6" /></svg>
              </a>
              <CartButton />
              <button
